          ...
          <div className="token-select-wrapper">
            <div className="token-select-header">
              <div className='header-left'>
                <h1>Combine Uints</h1>
                <div>{selected.length < 1 ? `Choose a token to keep (Delist if you don't want it to be sold)` : `Keeping ${selected[0].normalized_metadata.name}, now choose tokens to combine (burn)`}</div>
              </div>
